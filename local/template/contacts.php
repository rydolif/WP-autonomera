	...
	<section class="contacts">
		<div class="contacts__container container">
			...
			<div class="contacts__info">
				<h2><?php the_title(); ?></h2>
				<p class="contacts__sub-title">Вы можете связаться с нами любым удобным для Вас способом</p>
				...
				<p>
					<span>Телефон</span>
					<a href="tel:<?php the_field('tel-url', 'option'); ?>"><?php the_field('tel', 'option'); ?></a>
				</p>
				<p>
					<?php the_field('place1', 'option'); ?>
				</p>
				<p>
					<?php the_field('place2', 'option'); ?>
				</p>
				<p>
